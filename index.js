...
async function connectToWA() {
  ...
  console.log("Connecting THARUSHA-MD");
  ...
  robin.ev.on("connection.update", (update) => {
    ...
    if (connection === "close") {
      ...
      console.log("THARUSHA-MD installed successful ✅");
      console.log("THARUSHA-MD connected to whatsapp ✅");

      let up = `THARUSHA-MD connected successful ✅`;
      let up1 = `Hello Tharusha , I made bot successful`;
